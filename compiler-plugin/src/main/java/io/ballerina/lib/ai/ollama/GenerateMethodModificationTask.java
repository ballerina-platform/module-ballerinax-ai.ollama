 ...
 * for types used in Ollama model provider's `generate` method calls.
 *
 * @since 1.0.0
 */
class GenerateMethodModificationTask implements ModifierTask<SourceModifierContext> {
    ...
    public GenerateMethodModificationTask(AiOllamaCodeModifier.AnalysisData analysisData) {
    ...
    private class GenerateMethodJsonSchemaGenerator extends NodeVisitor {
        ...
        private static final String OLLAMA_MODEL_PROVIDER_NAME = "Provider";
        private static final String OLLAMA_MODEL_PROVIDER_MODULE_NAME = "ai.model.provider.ollama";
        ...
        void generate(ModulePartNode modulePartNode) {
            if (this.ollamaProviderSymbol == null) {
                return;
            }
        ...
        public void visit(RemoteMethodCallActionNode remoteMethodCallActionNode) {
            ...
            semanticModel.typeOf(expression).ifPresent(expressionTypeSymbol -> {
                if (expressionTypeSymbol.subtypeOf(this.ollamaProviderSymbol)) {
